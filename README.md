...
.
├── src/
│   ├── ex00_BBS_per.docx       # описание сущности Person
│   ├── ex01_BBS_per.xlsx       # описание Client и Employee
│   ├── ex02_BBS_per.xlsx       # роли, услуги и связь Employee–Service
│   ├── ex03_BBS_per.xlsx       # описание Slot
│   ├── ex04.diagram.png        # диаграмма классов
│   ├── ex05_BBS_per.xlsx       # скидки и уведомления
│   └── ex06.upd.png            # актуализированная диаграмма
├── materials/
│   ├── topics-list.md
│   └── topics-list_RUS.md
└── README.md
